...
var SYSDAO = new jetsennet.DefaultDal();
...
function formatState(value,row,index) {
	...
	return  value==1 ? '<img src="../easyui/themes/icons/ok.png" alt="正常" title="正常" />' : '<img src="../easyui/themes/icons/stop.png" alt="禁用" title="禁用" />'; 
}
...
function onEdit(){
 	...
 	if (row){
	 	...
	 	url = "../menu/save?parentid=0&id="+id;
	 	mesTitle = '编辑菜单成功';
 	}else{
