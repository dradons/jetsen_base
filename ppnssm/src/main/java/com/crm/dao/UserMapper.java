...
public interface UserMapper {
	...
	public List<User> getDatagrid(@Param("user")User user);

	public Long getDatagridTotal(@Param("user")User user,@Param("csysid")Integer sysid);

	public List<User> datagridUser(@Param("page")PageHelper page,@Param("csysid")Integer sysid,@Param("user")User user);
